    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 19, 13, 34, 4, 576, DateTimeKind.Local).AddTicks(7168), "İnsan kaynakları departmanı", true, "İnsan Kaynakları", null, null },
                    { 2, new DateTime(2025, 9, 19, 13, 34, 4, 576, DateTimeKind.Local).AddTicks(7342), "Bilgi işlem departmanı", true, "Bilgi İşlem", null, null },
                    { 3, new DateTime(2025, 9, 19, 13, 34, 4, 576, DateTimeKind.Local).AddTicks(7346), "Muhasebe departmanı", true, "Muhasebe", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, "#28a745", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(8113), "Yıllık ücretli izin", true, true, 5, 21, "Yıllık İzin", 3, true, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, "#dc3545", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(8123), "Sağlık raporu ile alınan izin", true, true, "Hastalık İzni", 1, true, true, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "#ff69b4", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(8128), "Annelik ve babalık izni", true, true, 128, "Doğum İzni", 30, true, true, null },
                    { 4, "#ffc107", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(8133), "Evlilik için verilen izin", true, true, 3, "Evlilik İzni", 7, true, true, null }
                });

            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "Id", "Color", "CreatedAt", "Description", "IsActive", "Name", "NotificationDays", "RequiresApproval", "UpdatedAt" },
                values: new object[] { 5, "#6c757d", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(8137), "Ücretsiz mazeret izni", true, "Mazeret İzni", 2, true, null });

            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "Id", "Color", "CreatedAt", "Description", "IsActive", "IsPaid", "MaxDaysPerYear", "Name", "NotificationDays", "RequiresApproval", "RequiresDocument", "UpdatedAt" },
                values: new object[] { 6, "#000000", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(8141), "Yakın akraba ölümü izni", true, true, 7, "Ölüm İzni", 1, true, true, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Programlama", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8386), ".NET Framework ve .NET Core kullanarak C# ile uygulama geliştirme becerisi", true, true, "C#, .NET, OOP, SOLID", null, "1:Temel | 2:Başlangıç | 3:Orta | 4:İleri | 5:Uzman", 5, "C# Programlama", "ASP.NET, Entity Framework", false, 1, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8388), 0, "Proje bazlı değerlendirme" },
                    { 2, "Web Geliştirme", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8396), "ASP.NET Core kullanarak web uygulamaları ve API geliştirme", true, true, "ASP.NET Core, MVC, Web API, Razor", null, "1:Temel | 2:Başlangıç | 3:Orta | 4:İleri | 5:Uzman", 5, "ASP.NET Core", "C#, JavaScript, HTML, CSS", false, 1, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8396), 0, "Proje ve kod incelemesi" },
                    { 3, "Veritabanı", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8401), "Microsoft SQL Server ile veritabanı tasarımı ve yönetimi", true, true, "SQL, T-SQL, Stored Procedures, Indexing", null, "1:Temel | 2:Başlangıç | 3:Orta | 4:İleri | 5:Uzman", 5, "SQL Server", "Entity Framework, Database Design", true, 1, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8402), 0, "SQL sorguları ve performans testleri" },
                    { 4, "Frontend Geliştirme", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8419), "JavaScript ve ES6+ özellikleri ile frontend geliştirme", true, true, "JavaScript, ES6, DOM, Async/Await", null, "1:Temel | 2:Başlangıç | 3:Orta | 4:İleri | 5:Uzman", 5, "JavaScript", "HTML, CSS, React, Vue.js", false, 1, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8420), 0, "Kod incelemesi ve proje değerlendirmesi" },
                    { 5, "Yönetim", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8424), "Proje planlama, takip ve yönetim becerileri", true, true, "PMP, Agile, Scrum, Kanban", null, "1:Temel | 2:Başlangıç | 3:Orta | 4:İleri | 5:Uzman", 5, "Proje Yönetimi", "Liderlik, İletişim, Risk Yönetimi", true, 2, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8425), 0, "Proje başarı oranları ve takım geri bildirimleri" },
                    { 6, "Dil", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8429), "İngilizce dil yeterliliği - konuşma, okuma, yazma", true, true, "English, TOEFL, IELTS, Business English", null, "1:Başlangıç | 2:Temel | 3:Orta | 4:İleri | 5:İleri Düzey", 5, "İngilizce", "İletişim, Sunum", true, 3, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8430), 0, "TOEFL, IELTS veya kurumsal dil sınavı" },
                    { 7, "Kişisel Gelişim", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8472), "Etkili iletişim kurma ve sürdürme becerileri", true, true, "Communication, Interpersonal, Presentation", null, "1:Temel | 2:Gelişen | 3:Yeterli | 4:İyi | 5:Mükemmel", 5, "İletişim", "Liderlik, Takım Çalışması", false, 2, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8473), 0, "360 derece değerlendirme" },
                    { 8, "Cloud Computing", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8477), "Microsoft Azure platformu ile cloud çözümleri geliştirme", true, true, "Azure, Cloud, DevOps, Containers", null, "1:Fundamentals | 2:Associate | 3:Expert | 4:Architect | 5:Master", 5, "Azure Cloud", "C#, PowerShell, Kubernetes", true, 1, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(8478), 0, "Microsoft Azure sertifikaları" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(6456), 1, "İnsan kaynakları süreçlerini yönetir, personel işlemleri ile ilgilenir", "Tam Zamanlı", true, "Mid-Level", 18000m, 12000m, "İnsan Kaynakları Uzmanı", 2, "Lisans mezunu, İnsan Kaynakları veya İşletme bölümü tercih edilir", "Personel işlemleri, bordro hazırlama, izin takibi, performans değerlendirme", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(6484), 2, "Web ve mobil uygulamalar geliştirir, sistem bakımı yapar", "Tam Zamanlı", true, true, "Senior", 25000m, 15000m, "Yazılım Geliştirici", 3, "Bilgisayar Mühendisliği mezunu, C#, .NET, SQL bilgisi", "Yazılım geliştirme, kod review, sistem analizi, dokümantasyon", null },
                    { 3, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(6491), 3, "Mali işleri yönetir, finansal raporlama yapar", "Tam Zamanlı", true, true, "Junior", 15000m, 10000m, "Muhasebe Uzmanı", 1, "İşletme veya İktisat mezunu, LUCA, Logo programları bilgisi", "Muhasebe kayıtları, mali raporlama, bütçe hazırlama, vergi işlemleri", null },
                    { 4, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(6496), 2, "Departmanlarda öğrenme ve gelişim süreci", "Stajyer", true, true, "Stajyer", 7000m, 5000m, "Stajyer", 0, "Üniversite 3. veya 4. sınıf öğrencisi", "Mentorluk eşliğinde proje desteği, öğrenme aktiviteleri", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9545), 1, null, null, "ahmet.yilmaz@company.com", "EMP001", null, null, "Ahmet", new DateTime(2023, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9062), true, "Yılmaz", null, null, null, "0555 123 45 67", 1, null, 15000m, null, null, "12345678901", null },
                    { 2, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9564), 1, null, null, "fatma.kaya@company.com", "EMP002", null, null, "Fatma", new DateTime(2024, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9559), true, "Kaya", null, null, null, "0555 123 45 68", 1, null, 12000m, null, null, "12345678902", null },
                    { 3, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9601), 2, null, null, "mehmet.demir@company.com", "EMP003", null, null, "Mehmet", new DateTime(2025, 1, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9570), true, "Demir", null, null, null, "0555 123 45 69", 2, null, 18000m, null, null, "12345678903", null },
                    { 4, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9623), 1, null, null, "ayse.sahin@company.com", "EMP004", null, null, "Ayşe", new DateTime(2025, 3, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9620), true, "Şahin", null, null, null, "0555 123 45 70", 1, null, 13000m, null, null, "12345678904", null },
                    { 5, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9629), 3, null, null, "can.ozkan@company.com", "EMP005", null, null, "Can", new DateTime(2022, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9627), true, "Özkan", null, null, null, "0555 123 45 71", 3, null, 22000m, null, null, "12345678905", null },
                    { 6, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9636), 2, null, null, "elif.yildiz@company.com", "EMP006", null, null, "Elif", new DateTime(2024, 11, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9633), true, "Yıldız", null, null, null, "0555 123 45 72", 1, null, 14000m, null, null, "12345678906", null },
                    { 7, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9642), 1, null, null, "burak.arslan@company.com", "EMP007", null, null, "Burak", new DateTime(2024, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9640), true, "Arslan", null, null, null, "0555 123 45 73", 2, null, 16000m, null, null, "12345678907", null },
                    { 8, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9647), 3, null, null, "zeynep.kurt@company.com", "EMP008", null, null, "Zeynep", new DateTime(2025, 5, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9646), true, "Kurt", null, null, null, "0555 123 45 74", 1, null, 11000m, null, null, "12345678908", null },
                    { 9, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9654), 2, null, null, "emre.celik@company.com", "EMP009", null, null, "Emre", new DateTime(2023, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9652), true, "Çelik", null, null, null, "0555 123 45 75", 4, null, 25000m, null, null, "12345678909", null },
                    { 10, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9670), 1, null, null, "seda.polat@company.com", "EMP010", null, null, "Seda", new DateTime(2025, 2, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9658), true, "Polat", null, null, null, "0555 123 45 76", 1, null, 13500m, null, null, "12345678910", null },
                    { 11, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9676), 3, null, null, "kerem.aydin@company.com", "EMP011", null, null, "Kerem", new DateTime(2024, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9674), true, "Aydın", null, null, null, "0555 123 45 77", 2, null, 17000m, null, null, "12345678911", null },
                    { 12, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9682), 2, null, null, "gizem.turan@company.com", "EMP012", null, null, "Gizem", new DateTime(2025, 4, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9680), true, "Turan", null, null, null, "0555 123 45 78", 1, null, 12500m, null, null, "12345678912", null },
                    { 13, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9688), 1, null, null, "cem.oz@company.com", "EMP013", null, null, "Cem", new DateTime(2021, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9686), true, "Öz", null, null, null, "0555 123 45 79", 3, null, 28000m, null, null, "12345678913", null },
                    { 14, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9694), 3, null, null, "deniz.koc@company.com", "EMP014", null, null, "Deniz", new DateTime(2024, 12, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9692), true, "Koç", null, null, null, "0555 123 45 80", 1, null, 14500m, null, null, "12345678914", null },
                    { 15, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9700), 2, null, null, "murat.aktas@company.com", "EMP015", null, null, "Murat", new DateTime(2023, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9698), true, "Aktaş", null, null, null, "0555 123 45 81", 2, null, 19000m, null, null, "12345678915", null },
                    { 16, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9761), 1, null, null, "pinar.gunes@company.com", "EMP016", null, null, "Pınar", new DateTime(2025, 6, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9746), true, "Güneş", null, null, null, "0555 123 45 82", 1, null, 11500m, null, null, "12345678916", null },
                    { 17, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9768), 3, null, null, "okan.bulut@company.com", "EMP017", null, null, "Okan", new DateTime(2022, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9766), true, "Bulut", null, null, null, "0555 123 45 83", 4, null, 26000m, null, null, "12345678917", null },
                    { 18, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9773), 2, null, null, "nihan.erdogan@company.com", "EMP018", null, null, "Nihan", new DateTime(2025, 3, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9772), true, "Erdoğan", null, null, null, "0555 123 45 84", 1, null, 13200m, null, null, "12345678918", null },
                    { 19, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9779), 1, null, null, "tolga.yavuz@company.com", "EMP019", null, null, "Tolga", new DateTime(2024, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9777), true, "Yavuz", null, null, null, "0555 123 45 85", 2, null, 17500m, null, null, "12345678919", null },
                    { 20, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9784), 3, null, null, "esra.tan@company.com", "EMP020", null, null, "Esra", new DateTime(2023, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9783), true, "Tan", null, null, null, "0555 123 45 86", 3, null, 23000m, null, null, "12345678920", null },
                    { 21, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9790), 1, null, null, "serkan.cakir@company.com", "EMP021", null, null, "Serkan", new DateTime(2025, 1, 19, 13, 34, 4, 577, DateTimeKind.Local).AddTicks(9788), true, "Çakır", null, null, null, "0555 123 45 87", 1, null, 14200m, null, null, "12345678921", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(1607), "Lisans", null, new DateTime(2022, 6, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "İnsan Kaynakları Yönetimi", 3.45m, true, "İstanbul", 1, "İstanbul Üniversitesi", new DateTime(2018, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(1615), "Yüksek Lisans", null, null, "İşletme", null, true, true, "Eskişehir", 1, "Anadolu Üniversitesi", new DateTime(2022, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(488), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(373), 1, 1.75m, 1, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 2, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(514), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(513), 2, 1, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(523), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(522), 4, 1, 3.0m, null, 2025 },
                    { 4, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(530), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(529), 6, 1, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 5, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(538), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(537), 1, 1.75m, 2, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 6, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(544), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(543), 2, 2, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(547), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(547), 4, 2, 3.0m, null, 2025 },
                    { 8, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(551), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(550), 6, 2, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 9, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(555), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(554), 1, 1.75m, 3, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 10, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(597), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(596), 2, 3, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 11, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(600), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(600), 4, 3, 3.0m, null, 2025 },
                    { 12, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(603), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(603), 6, 3, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 13, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(607), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(606), 1, 1.75m, 4, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 14, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(610), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(610), 2, 4, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 15, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(614), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(613), 4, 4, 3.0m, null, 2025 },
                    { 16, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(617), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(617), 6, 4, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 17, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(620), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(620), 1, 1.75m, 5, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 18, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(625), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(625), 2, 5, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 19, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(628), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(628), 4, 5, 3.0m, null, 2025 },
                    { 20, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(632), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(631), 6, 5, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 21, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(635), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(634), 1, 1.75m, 6, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 22, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(638), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(638), 2, 6, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 23, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(641), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(641), 4, 6, 3.0m, null, 2025 },
                    { 24, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(644), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(644), 6, 6, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 25, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(648), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(647), 1, 1.75m, 7, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 26, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(651), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(650), 2, 7, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 27, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(654), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(653), 4, 7, 3.0m, null, 2025 },
                    { 28, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(657), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(657), 6, 7, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 29, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(660), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(660), 1, 1.75m, 8, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 30, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(663), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(663), 2, 8, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 31, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(667), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(666), 4, 8, 3.0m, null, 2025 },
                    { 32, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(670), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(669), 6, 8, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 33, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(673), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(672), 1, 1.75m, 9, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 34, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(677), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(677), 2, 9, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 35, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(680), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(680), 4, 9, 3.0m, null, 2025 },
                    { 36, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(684), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(683), 6, 9, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 37, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(687), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(686), 1, 1.75m, 10, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 38, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(690), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(690), 2, 10, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 39, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(724), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(723), 4, 10, 3.0m, null, 2025 },
                    { 40, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(727), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(726), 6, 10, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 41, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(730), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(730), 1, 1.75m, 11, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 42, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(734), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(733), 2, 11, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 43, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(738), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(737), 4, 11, 3.0m, null, 2025 },
                    { 44, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(741), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(741), 6, 11, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 45, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(745), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(744), 1, 1.75m, 12, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 46, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(748), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(748), 2, 12, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 47, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(751), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(751), 4, 12, 3.0m, null, 2025 },
                    { 48, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(754), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(754), 6, 12, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 49, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(757), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(757), 1, 1.75m, 13, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 50, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(761), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(760), 2, 13, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 51, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(764), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(763), 4, 13, 3.0m, null, 2025 },
                    { 52, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(767), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(766), 6, 13, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 53, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(770), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(770), 1, 1.75m, 14, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 54, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(774), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(773), 2, 14, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 55, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(777), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(776), 4, 14, 3.0m, null, 2025 },
                    { 56, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(780), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(779), 6, 14, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 57, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(783), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(783), 1, 1.75m, 15, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 58, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(786), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(786), 2, 15, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 59, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(789), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(789), 4, 15, 3.0m, null, 2025 },
                    { 60, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(793), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(792), 6, 15, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 61, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(796), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(795), 1, 1.75m, 16, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 62, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(799), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(798), 2, 16, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 63, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(802), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(802), 4, 16, 3.0m, null, 2025 },
                    { 64, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(805), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(805), 6, 16, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 65, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(808), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(808), 1, 1.75m, 17, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 66, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(813), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(813), 2, 17, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 67, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(836), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(836), 4, 17, 3.0m, null, 2025 },
                    { 68, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(840), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(839), 6, 17, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 69, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(843), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(843), 1, 1.75m, 18, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 70, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(846), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(846), 2, 18, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 71, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(850), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(849), 4, 18, 3.0m, null, 2025 },
                    { 72, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(853), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(853), 6, 18, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 73, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(856), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(856), 1, 1.75m, 19, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 74, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(860), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(859), 2, 19, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 75, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(863), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(863), 4, 19, 3.0m, null, 2025 },
                    { 76, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(866), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(866), 6, 19, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 77, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(870), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(870), 1, 1.75m, 20, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 78, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(873), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(873), 2, 20, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 79, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(876), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(876), 4, 20, 3.0m, null, 2025 },
                    { 80, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(879), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(879), 6, 20, 7.0m, null, 2025 }
                });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AccruedToDate", "AdjustmentDate", "AdjustmentReason", "AllocatedDays", "AvailableDays", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "MonthlyAccrual", "PersonId", "RemainingDays", "UpdatedAt", "Year" },
                values: new object[] { 81, 21.0m, null, null, 21.0m, 21.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(883), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(882), 1, 1.75m, 21, 21.0m, null, 2025 });

            migrationBuilder.InsertData(
                table: "LeaveBalances",
                columns: new[] { "Id", "AdjustmentDate", "AdjustmentReason", "CreatedAt", "IsActive", "LastAccrualDate", "LeaveTypeId", "PersonId", "UpdatedAt", "Year" },
                values: new object[] { 82, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(886), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(885), 2, 21, null, 2025 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 83, 3.0m, null, null, 3.0m, 3.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(889), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(889), 4, 21, 3.0m, null, 2025 },
                    { 84, 7.0m, null, null, 7.0m, 7.0m, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(892), true, new DateTime(2025, 9, 19, 13, 34, 4, 579, DateTimeKind.Local).AddTicks(892), 6, 21, 7.0m, null, 2025 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "İstanbul, Türkiye", "GM001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(3853), "Ana organizasyon birimi", "genel@ikys.com", true, "Genel Müdür", 1, "Genel Müdürlük", null, "0212 123 45 67", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(9662), null, null, null, null, null, 5, true, false, false, true, null, 4, 1, null, 1, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(9663) },
                    { 2, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(9669), null, null, null, null, null, 4, true, false, false, true, null, 4, 1, null, 2, new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(9669) },
                    { 3, null, null, "Microsoft", new DateTime(2025, 3, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(9673), new DateTime(2027, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(9808), null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(32), null, null, null, null, null, 3, true, true, false, false, null, 3, 1, null, 3, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(33) },
                    { 4, null, null, "ETS", new DateTime(2024, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(52), null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(55), null, null, null, null, null, 8, true, true, false, false, null, 3, 1, null, 6, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(56) },
                    { 5, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(59), null, null, null, null, null, 4, true, false, false, true, null, 3, 2, null, 5, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(60) },
                    { 6, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(63), null, null, null, null, null, 6, true, false, false, true, null, 4, 2, null, 7, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(64) },
                    { 7, null, null, "Cambridge", new DateTime(2025, 1, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(66), null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(68), null, null, null, null, null, 10, true, true, false, false, null, 4, 2, null, 6, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(69) },
                    { 8, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(72), null, null, null, null, null, 2, true, false, false, true, null, 3, 3, null, 7, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(72) },
                    { 9, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(75), null, null, null, null, null, 5, true, false, false, true, null, 2, 3, null, 6, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(76) },
                    { 10, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(505), null, new DateTime(2025, 9, 4, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(288), 1, "Mükemmel C# becerileri, takım liderliği yapabilir", null, 8, true, false, true, false, null, 5, 4, null, 1, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(506) },
                    { 11, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(512), null, new DateTime(2025, 9, 4, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(511), 1, null, null, 6, true, false, true, false, null, 5, 4, null, 2, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(513) },
                    { 12, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(516), null, null, null, null, null, 5, true, false, false, true, null, 4, 4, null, 4, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(517) },
                    { 13, null, null, "Microsoft", new DateTime(2025, 6, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(519), new DateTime(2028, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(521), null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(523), null, null, null, null, null, 2, true, true, false, false, null, 3, 4, null, 8, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(523) },
                    { 14, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(526), null, null, null, null, null, 1, true, false, false, true, null, 2, 5, null, 1, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(527) },
                    { 15, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(530), null, null, null, null, null, 1, true, false, false, true, null, 2, 5, null, 4, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(530) },
                    { 16, null, null, null, null, null, null, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(533), null, null, null, null, null, 4, true, false, false, true, null, 3, 5, null, 6, new DateTime(2025, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(534) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Teknik", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(3352), "AZ-900-2023-001", "Azure bulut hizmetleri temel bilgileri ve sertifikasyonu", new DateTime(2026, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), true, true, new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Microsoft", "Başlangıç", "İstanbul", "Microsoft Azure Fundamentals", 1, 85, null },
                    { 2, null, "Dil", new DateTime(2025, 9, 19, 13, 34, 4, 578, DateTimeKind.Local).AddTicks(3360), "IELTS-2023-789456", "İngilizce dil yeterlilik sınavı - Akademik modül", new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), true, true, new DateTime(2023, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "British Council", "B2", "Ankara", "IELTS Academic", 1, 75, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, "Temizlik Malzemeleri", "TM001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6264), "Genel temizlik deterjanı", null, true, true, new DateTime(2025, 9, 7, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6263), "Depo-C-01", 50, 10, "Deterjan", 1, 25, "Temizlik A.Ş.", "Litre", 18.50m, null },
                    { 6, "Temizlik Malzemeleri", "TM002", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6270), "Beyaz kağıt havlu", null, true, true, new DateTime(2025, 9, 14, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6269), "Depo-C-02", 60, 15, "Kağıt Havlu", 1, 35, "Temizlik A.Ş.", "Paket", 12.00m, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "İstanbul, Türkiye", "IK001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(3862), "İnsan kaynakları yönetimi", "ik@ikys.com", true, "İK Müdürü", 2, "İnsan Kaynakları Bölümü", 1, "0212 123 45 68", null },
                    { 3, "İstanbul, Türkiye", "BI001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(3866), "Teknoloji ve bilgi işlem", "bi@ikys.com", true, "BI Müdürü", 3, "Bilgi İşlem Bölümü", 1, "0212 123 45 69", null },
                    { 4, "İstanbul, Türkiye", "MH001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(3870), "Mali işler ve muhasebe", "muhasebe@ikys.com", true, "Muhasebe Müdürü", 5, "Muhasebe Bölümü", 1, "0212 123 45 70", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, new DateTime(2025, 9, 9, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(1721), null, 4, new DateTime(2025, 9, 9, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2477), "Çok iyi kod kalitesi, best practices'i takip ediyor. Devam etsin, liderlik becerileri geliştirebilir.", null, true, true, 1, null, null, 8, 3, new DateTime(2025, 9, 9, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2480), new DateTime(2026, 3, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2300) },
                    { 2, 5, new DateTime(2025, 9, 14, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2488), null, 1, new DateTime(2025, 9, 14, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2491), "Uzman seviyede, kompleks problemleri çözebiliyor. Takım mentorluk görevlerini üstlenebilir.", null, true, true, 10, null, null, 10, 4, new DateTime(2025, 9, 14, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2492), new DateTime(2026, 9, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2489) },
                    { 3, 4, new DateTime(2025, 8, 30, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2496), null, 2, new DateTime(2025, 8, 30, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2499), "Takım içi iletişimde çok başarılı. Sunum becerileri geliştirilebilir.", null, true, true, 6, null, null, 8, 1, new DateTime(2025, 8, 30, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2500), new DateTime(2025, 12, 19, 13, 34, 4, 581, DateTimeKind.Local).AddTicks(2497) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ofis Malzemeleri", "OF001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6215), "Beyaz A4 yazıcı kağıdı", null, true, true, new DateTime(2025, 9, 4, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6043), "Depo-A-01", 200, 20, "A4 Kağıt", 2, 150, "Kağıt A.Ş.", "Paket", 25.50m, null },
                    { 2, "Ofis Malzemeleri", "OF002", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6228), "HP LaserJet toner kartuşu", null, true, true, new DateTime(2025, 9, 11, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6224), "Depo-A-02", 25, 5, "Toner Kartuş", 3, 12, "Teknoloji Ltd.", "Adet", 350.00m, null },
                    { 3, "Bilgisayar Ekipmanları", "BT001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6250), "Mekanik klavye", null, true, false, new DateTime(2025, 8, 20, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6234), "Depo-B-01", 15, 3, "Klavye", 3, 8, "Teknoloji Ltd.", "Adet", 150.00m, null },
                    { 4, "Bilgisayar Ekipmanları", "BT002", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6258), "Optik mouse", null, true, false, new DateTime(2025, 8, 30, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6257), "Depo-B-02", 20, 5, "Mouse", 3, 15, "Teknoloji Ltd.", "Adet", 75.00m, null },
                    { 7, "Kırtasiye", "KR001", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6276), "Mavi tükenmez kalem", null, true, true, new DateTime(2025, 9, 9, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6275), "Depo-A-03", 150, 30, "Kalem", 2, 100, "Kırtasiye Ltd.", "Adet", 3.50m, null },
                    { 8, "Kırtasiye", "KR002", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6281), "Plastik klasör dosya", null, true, false, new DateTime(2025, 9, 1, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6280), "Depo-A-04", 80, 20, "Dosya", 2, 45, "Kırtasiye Ltd.", "Adet", 8.75m, null },
                    { 9, "Ofis Malzemeleri", "OF003", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6297), "Siyah mürekkep kartuşu", null, true, true, new DateTime(2025, 8, 5, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6296), "Depo-A-05", 20, 5, "Yazıcı Mürekkep", 3, 2, "Teknoloji Ltd.", "Adet", 85.00m, null },
                    { 10, "Ofis Malzemeleri", "OF004", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6303), "A3 fotokopi kağıdı", null, true, true, new DateTime(2025, 7, 21, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6302), "Depo-A-06", 15, 3, "Fotokopi Kağıdı", 2, 1, "Kağıt A.Ş.", "Paket", 35.00m, null },
                    { 11, "Kırtasiye", "KR003", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6309), "Standart zımba teli", null, true, true, new DateTime(2025, 9, 12, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6307), "Depo-A-07", 30, 10, "Zımba Teli", 2, 45, "Kırtasiye Ltd.", "Kutu", 4.50m, null },
                    { 12, "Kırtasiye", "KR004", new DateTime(2025, 9, 19, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6314), "Fosforlu işaretleme kalemi", null, true, true, new DateTime(2025, 9, 16, 13, 34, 4, 580, DateTimeKind.Local).AddTicks(6313), "Depo-A-08", 60, 20, "Bantlı Kalem", 2, 95, "Kırtasiye Ltd.", "Adet", 6.25m, null }
                });
